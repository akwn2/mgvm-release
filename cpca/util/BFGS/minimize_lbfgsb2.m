function [X, fX, i] = minimize_lbfgsb2(self, X, f, length)

% Minimize a differentiable multivariate function using quasi Newton.
%
% Usage: [X, fX, i] = minimize_lbfgsb(self, X, f, length)
% self    object who has the objective f as its method.
...
X = lbfgsb( unwrap(X0), lb, ub, 'minimize_lbfgsb_objfun2', ...
                                'minimize_lbfgsb_gradfun2', ...
         {f, X0, self}, [], ...
