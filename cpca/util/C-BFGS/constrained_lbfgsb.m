function [x,f,info] = constrained_lbfgsb( fcn, l, u, opts )
% x = constrained_lbfgsb( fcn, l, u )
...
try
    ...
    % version not compatible, so implement 
    if nargin < 3 || nargin > 4
        ME = MException('lbfgs:wrongNumberOfInputs',...
                        'LBFGS takes 3 to 4 inputs.');
        throw(ME);
    end
end
